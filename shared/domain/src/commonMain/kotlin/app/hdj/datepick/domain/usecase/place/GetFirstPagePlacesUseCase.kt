...
@Singleton
class GetFirstPagePlacesUseCase @Inject constructor(private val placeRepository: PlaceRepository) :
    UseCase<PlaceQueryParams, Flow<LoadState<List<Place>>>> {

    override fun invoke(input: PlaceQueryParams) = placeRepository.queryFirstPagePlaces(input)
