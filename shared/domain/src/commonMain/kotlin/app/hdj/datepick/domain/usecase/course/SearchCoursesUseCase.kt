...
class SearchCoursesUseCase @Inject constructor(private val courseRepository: CourseRepository) :
    UseCase<CourseQueryParams, Flow<PagingData<Course>>> {

    override fun invoke(input: CourseQueryParams): Flow<PagingData<Course>> =
        courseRepository.queryPagedCourses(input)
